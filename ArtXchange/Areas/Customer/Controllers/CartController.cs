...
namespace ArtXchange.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Plus(int cartId)
        {
            ...
            cart.Count += 1;
            cart.Price = SD.GetPriceBasedOnQuantity(cart.Count, cart.Product.Price, cart.Product.Price3, cart.Product.Price6);
            _unitOfWork.Save();
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            else
            {
                ...
                cart.Price = SD.GetPriceBasedOnQuantity(cart.Count, cart.Product.Price,
                                    cart.Product.Price3, cart.Product.Price6);
                _unitOfWork.Save();
            }
        ...
        public IActionResult SummaryPost(string stripeToken)
        {
            ...
            {
                item.Price = SD.GetPriceBasedOnQuantity(item.Count, item.Product.Price, item.Product.Price3, item.Product.Price6);
